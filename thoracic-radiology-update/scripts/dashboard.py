...
Generates: index.html (monthly report with all summaries + podcast player)
"""
...
def _topic_card(ts: dict, podcast_path: str | None = None) -> str:
    """Renders an HTML card for a single topic."""
...
def build_dashboard(
    ...
    """Builds the full HTML dashboard and writes it to output_dir/index.html."""
    ...
    if podcast_filename:
        ...
        <div class="podcast-section" id="podcast">
            ...
            <div class="podcast-download">
                <a href="{podcast_filename}" download class="download-btn">⬇️ Descargar MP3</a>
    ...
    <style>
        * {{ box-sizing: border-box; margin: 0; padding: 0; }}
        ...
        .page-header::before {{
            ...
            width: 400px;
            height: 400px;
            background: radial-gradient(circle, #3498db20, transparent 70%);
            border-radius: 50%;
        }}
        ...
        .podcast-download {{ display: flex; gap: 10px; }}
...
<script>
    function toggleCard(topicId) {{
        ...
        btn.textContent = body.classList.contains('collapsed') ? '▼ Ver resumen' : '▲ Cerrar';
    }}
    ...
    # Also write podcast script as plain text if present
